            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <h2> Food <small class="hidden-xs-down hidden-sm-down"></small></h2>
                    </div><!-- end col -->
...
<?php
  ...
  { 
   ...
   $user_query = "select username from user where user_id = '$author_id'";
   $user_result = mysqli_query($con,$user_query);
   while($author = mysqli_fetch_assoc($user_result))
   {
...
?>
                                    ...
                                    <div class="blog-box row">
                                        ...
                                        <div class="blog-meta big-meta col-md-8">
                                            ...
                                            <small><a href="tech-single.html" title=""><?php echo $update_date ?></a></small>
                                            <small><a href="tech-author.html" title=""><?php echo $author_name ?></a></small>
